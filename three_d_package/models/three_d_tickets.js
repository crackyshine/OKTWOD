...
threeDTicketSchema.plugin(autoIncrement.plugin, {
    model: "three_d_tickets", // collection or table name in which you want to apply auto increment
    field: "voucher_id", // field of model which you want to auto increment
    startAt: 1, // start your auto increment value from 1
    incrementBy: 1, // incremented by 1
});
const THREE_D_TICKET_DB = MONGO.model('three_d_ticket', threeDTicketSchema);
module.exports = THREE_D_TICKET_DB;