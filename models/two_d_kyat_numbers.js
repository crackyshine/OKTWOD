...
const twoDKyatNumberSchema = new Schema({
...
twoDKyatNumberSchema.plugin(autoIncrement.plugin, {
    model: "two_d_kyat_numbers", // collection or table name in which you want to apply auto increment
    field: "voucher_id", // field of model which you want to auto increment
    startAt: 1, // start your auto increment value from 1
    incrementBy: 1, // incremented by 1
});
const TwoDKyatNumberDB = MONGO.model('two_d_kyat_number', twoDKyatNumberSchema);
module.exports = TwoDKyatNumberDB;